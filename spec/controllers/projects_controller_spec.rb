...
describe ProjectsController do
  ...
  describe "GET index" do
    it "assigns all projects as @projects" do
      Project.stub!(:find).with(:all, :include => :project_sessions).and_return([mock_project])
      get :index
  ...
  describe "GET show" do
    it "assigns the requested project as @project" do
      ...
      mock_session = mock_model(ProjectSession)
      project_sessions = mock("Project Sessions", :running => [mock_session])
      mock_project.should_receive(:project_sessions).and_return(project_sessions)
      get :show, :id => "37"
      assigns[:project].should equal(mock_project)
      assigns[:project_session].should equal(mock_session)
    end
  end
